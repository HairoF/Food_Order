...
function calculator() {
  var resultCal = document.querySelector('.calculating__result span');
...
function cards() {
  ...
  Object(_services_services__WEBPACK_IMPORTED_MODULE_3__["getResours"])('http://localhost:3000/menu').then(function (data) {
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (event) {
      ...
      Object(_services_services__WEBPACK_IMPORTED_MODULE_9__["postData"])('http://localhost:3000/requests', json).then(function (response) {
  ...
  function showThanksModal(message) {
    var previousModalDialog = document.querySelector('.modal__dialog');
    ...
    setTimeout(function () {
      ...
      Object(_modal__WEBPACK_IMPORTED_MODULE_8__["closeModal"])('.modal');
    }, 5000);
  }
}
...
function modal(windowSelector, modalSelector, modalTimerId) {
  var modalWindow = document.querySelectorAll(windowSelector),
      modal = document.querySelector(modalSelector);
  modalWindow.forEach(function (btn) {
    btn.addEventListener('click', function () {
      return openModal(modalSelector, modalTimerId);
    });
  });
  modal.addEventListener('click', function (event) {
    // close modal with event.target
...
function slider(_ref) {
  var container = _ref.container,
      ...
      field = _ref.field;
  var slids = document.querySelectorAll(slide),
  ...
  if (slids.length < 10) {
    total.innerHTML = "0".concat(slids.length);
    current.innerHTML = "0".concat(slidesIndex);
  } else {
  ...
  slider.style.position = 'relative'; //generate dots for sliders

  var dotsInd = document.createElement('ol'),
      dots = [];
  ...
  next.addEventListener('click', function () {
    ...
    slidsField.style.transform = "translateX(-".concat(offset, "px)");
...
function timer(id, deadLine) {
  ...
  function setClock(selector, endtime) {
    ...
    function updateClock() {
      ...
      days.textContent = getTwoDigits(t.days), hours.textContent = getTwoDigits(t.hours), minutes.textContent = getTwoDigits(t.minutes), seconds.textContent = getTwoDigits(t.seconds);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2020-10-20');
...
var getResours = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            throw new Error("Couldn't fetch ".concat(url, ", with status: ").concat(result.status));
  ...
  return function getResours(_x3) {
